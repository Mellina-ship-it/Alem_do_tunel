//Este código implementa um jogo narrativo interativo baseado no filme "A Viagem de Chihiro" (Studio Ghibli)
// graph TD
 // A[Menu Inicial] --> B[Cena 0 - Introdução]
 // B --> C[Fase 1 - Túnel Misterioso]
//  C --> D{Decisão 1}
//  D -->|Opção A| E[Caminho A]
 // D -->|Opção B| F[Caminho B]
 // E --> G[...]
//  F --> H[...]
let vidas = 3;
let cenaAtual = 0;
